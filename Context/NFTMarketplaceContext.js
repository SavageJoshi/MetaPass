...
const projectId = "2PgbzzWjbNGpiN6DN30Il0V4yem";
const projectSecretKey = "9c0c12da787c5b21cb9329787ccaf948";
const auth = `Basic ${Buffer.from(`${projectId}:${projectSecretKey}`).toString(
  "base64"
)}`;

const subdomain = "https://sarvesh-nftmarketplace.infura-ipfs.io";
